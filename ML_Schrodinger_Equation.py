# -*- coding: utf-8 -*-
"""
Created on Fri Jun 21 18:38:43 2019
...
if __name__ == "__main__":
    ...
    Create_Neural_Net = True
    if Generate_Training_Data == True:
        omegas = np.linspace(1, 10, 50)
        ms = [1]
        degrees = range(10)
        n = 10 # random points
        ...
        plot_results(json_data, lists=[0], figname='Trainig_result.png')
        
    if Generate_Test_Data == True:
        omegas = np.linspace(1, 10, 5)
        ms = [1] # Do not change, change omega as needed instead
        degrees = range(3)
        n = 10 # random points
        ...
        plot_results(json_data, lists=[0], figname='Test_Results.png')
    ...
    # load the data
    X, y, z = [], [], []
    json_data = loadfn('Training_Data.json', cls=MontyDecoder)
    ...
    X1, y1, z1 = [], [], []
    json_data1 = loadfn('Test_Data.json', cls=MontyDecoder)
